...
int main()
{
	...
	ResourceSystem::Instance()->LoadTextureMap("mogila", "Resources/Textures/Mogila.png", {64, 64}, 1, false);
	...
	ResourceSystem::Instance()->LoadSound("death", "Resources/Sounds/Death.wav");
