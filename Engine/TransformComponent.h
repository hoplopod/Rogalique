...
namespace Engine
{
	...
	public:
		...
		void SetEndCoordinats(const Vector2Df& position, Position axis);
		...
		float GetPowerSmooth(float scale);
		bool GetSmoothPush() const;
		void SetSignAxis(Position axis);
		Position GetSignAxis() const;
